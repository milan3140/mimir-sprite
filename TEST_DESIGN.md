...
| F4 collapse × F7 detail-open | collapse while a detail is open → clean collapse, detail state persists | probe_panel F4 (collapse fires; detailOpen still true after re-expand) | ✅ |
