...
declare global {
  interface Window {
    api: {
      ...
      onExpandedChanged: (cb: (v: { expanded: boolean; edge: string; catOffset?: number; winX?: number; winY?: number; wa?: { x: number; y: number; width: number; height: number } }) => void) => () => void
